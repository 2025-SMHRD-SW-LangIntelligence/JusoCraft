...
export default function StatsCard({
    ...
    footerText,
    footerHighlight,
    bgColor = "from-pink-600 to-pink-400 shadow-pink-500/40",
    to = "", // ← 추가된 props (ex: "/dashboard/fire")
}) {
    const CardContent = (
        <div
            className="relative flex flex-col bg-white rounded-xl text-gray-700 shadow-lg border transition-transform hover:scale-[1.015]"
            style={{
